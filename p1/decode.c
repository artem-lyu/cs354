...
// Main File:        decode.c
// This File:        decode.c
// Other Files:      decode.i, decode.s, decode.o, decode*, cipher.txt, myfortune.txt, objectfile_contents.txt, execfile_contents.txt
 ...
 * using a (not so) secret key based on the CS login of the intended recipient.
 */
